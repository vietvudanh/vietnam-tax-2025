...
├── data/             # Static datasets (incl. demoProfiles.ts - 12 taxpayer profiles)
├── components/       # Reusable React components (incl. DemoProfiles.tsx, LawChangelog.tsx)
...
6. **Demo Profiles tab**: 20 pre-defined taxpayer archetypes (200M/yr, 500M/yr, 1B/yr, 100M/mo, Freelancer, dual-income, expat, voluntary pension, and famous meme profiles like Vozer 350M/mo, Nguoi anh 96 20k USD/mo...) with
